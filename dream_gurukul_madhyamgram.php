                    ...
                    <div class="floor-plans-container">
                        ...
                        <div class="floor-plans-item">
                            ...
                            <button class="floor-plans-view-button" onclick="enquiryForm('floor plan')">View
                                Plan</button>
                            <img loading="lazy"
                                src="dream_gurukul_madhyamgram/assets/Floor and Master plans/Tower B.webp"
                                alt="Floor Plan 3">
                        </div>
                        <div class="floor-plans-item">
                            ...
                            <button class="floor-plans-view-button" onclick="enquiryForm('floor plan')">View
                                Plan</button>
                            <img loading="lazy"
                                src="dream_gurukul_madhyamgram/assets/Floor and Master plans/Tower B 2.webp"
                                alt="Floor Plan 3">
                        </div>
                        <!-- Add more items as needed -->
                    </div>
                    ...
                    <div class="master-floor-plans-container">
                        <div class="master-floor-plans-item">
                            ...
                            <button class="floor-plans-view-button" onclick="enquiryForm('floor plan')">View
                                Plan</button>
                            <img loading="lazy"
                                src="dream_gurukul_madhyamgram/assets/Floor and Master plans/Master Plan.jpg"
                                alt="Master Plan 1">
                        </div>
                        <!-- <div class="master-floor-plans-item">
                ...
                <div class="map-container">
                    ...
                    <div class="map-item">
                        <ul>
                            ...
                            <li>
                                <div class="location-name"> Julien Day School (ICSE)</div>
                                <div class="location-dots">..........</div>
                                <div class="location-dots-mobile">.....</div>
                                <div class="location-time">2 min</div>
                            </li>
                            <li>
                                <div class="location-name">Sudhir Memorial Institute (CBSE)</div>
                                <div class="location-dots">..........</div>
                                <div class="location-dots-mobile">.....</div>
                                <div class="location-time">3 min</div>
                            </li>
                            <li>
                                <div class="location-name">Monalisa English Medium School (ICSE)</div>
                                <div class="location-dots">..........</div>
                                <div class="location-dots-mobile">.....</div>
                                <div class="location-time">5 min</div>
                            </li>
                            <li>
                                <div class="location-name">Calcutta Public School (ICSE)</div>
                                <div class="location-dots">..........</div>
                                <div class="location-dots-mobile">.....</div>
                                <div class="location-time">9 min</div>
                            </li>
                            <li>
                                <div class="location-name">Indira Gandhi Memorial School (CBSE)</div>
                                <div class="location-dots">..........</div>
                                <div class="location-dots-mobile">.....</div>
                                <div class="location-time">9 min</div>
                            </li>
                            <li>
                                <div class="location-name"> Camellia Public School (CBSE)</div>
                                <div class="location-dots">..........</div>
                                <div class="location-dots-mobile">.....</div>
                                <div class="location-time">15 min</div>
                            </li>
                            <li>
                                <div class="location-name">Delhi Public International School (ICSE/ISC)</div>
                                <div class="location-dots">..........</div>
                                <div class="location-dots-mobile">.....</div>
                                <div class="location-time">7 min</div>
                            </li>
                            <li>
                                <div class="location-name"> Barasat DPS (CBSE)</div>
                                <div class="location-dots">..........</div>
                                <div class="location-dots-mobile">.....</div>
                                <div class="location-time">9 min</div>
                            </li>
                            <li>
                                <div class="location-name"> Adamas World School (CBSE)</div>
                                <div class="location-dots">..........</div>
                                <div class="location-dots-mobile">.....</div>
                    ...
                    <div class="map-item">
                        <ul>
                            ...
                            <li>
                                <div class="location-name"> Adamas University (Adamas Knowledge City)</div>
                                <div class="location-dots">..........</div>
                                <div class="location-dots-mobile">.....</div>
                                <div class="location-time">26 min</div>
                            </li>
                    ...
                    <div class="map-item">
                        <ul>
                            ...
                            <li>
                                <div class="location-name"> Icon Healthcare Multispeciality Hospital, Madhyamgram</div>
                                <div class="location-dots">..........</div>
                                <div class="location-dots-mobile">.....</div>
                                <div class="location-time">3 min</div>
                            </li>
                            ...
                            <li>
                                <div class="location-name"> Care & Cure Hospital, Barasat</div>
                                <div class="location-dots">..........</div>
                                <div class="location-dots-mobile">.....</div>
                            ...
                            <li>
                                <div class="location-name"> Disha Eye Hospital, Barasat</div>
                                <div class="location-dots">..........</div>
                                <div class="location-dots-mobile">.....</div>
